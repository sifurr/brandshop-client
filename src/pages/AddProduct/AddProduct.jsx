        ...
        <div className="bg-gray-900 min-h-screen py-10">
            ...
            <form className="w-2/3 mx-auto text-black">                
                <div className="grid gap-6 mb-6 md:grid-cols-2">                    
                    ...
                    <div>
                        <label htmlFor="phone" className="block mb-2 text-sm font-medium text-white dark:text-white">Type</label>
                        <input type="text" name="type" id="phone" className="bg-gray-50 border border-gray-300 text-black text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Product type" pattern="[0-9]{3}-[0-9]{2}-[0-9]{3}" required />
                    </div>
                    <div>
