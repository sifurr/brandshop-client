    ...
    return (
        <div className="bg-gray-900 min-h-screen py-10">
            ...
            <form onSubmit={handleUpdateProduct} className="w-2/3 mx-auto text-black">
                ...
                <button type="submit" className="text-white bg-gray-500 hover:bg-gray-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update</button>
            </form>
